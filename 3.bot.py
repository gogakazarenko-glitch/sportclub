...
BOT_TOKEN = "8573823509:AAEpF2YiNUGztv_rC5RaOKx9-G2Mpx6CrEA"
ADMIN_ID = 2027162196
...
def booking_day(call):
    ...
    markup = InlineKeyboardMarkup()
    for day in ["понедельник", "четверг", "суббота"]:
        markup.add(InlineKeyboardButton(day.capitalize(), callback_data=f"day_{sport}_{day}"))
